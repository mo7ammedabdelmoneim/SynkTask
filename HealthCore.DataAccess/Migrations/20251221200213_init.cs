        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TeamLeads_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectTasks_TeamLeads_TeamLeadId",
                        column: x => x.TeamLeadId,
                        principalTable: "TeamLeads",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Todos_ProjectTasks_TaskId",
                        column: x => x.TaskId,
                        principalTable: "ProjectTasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Todos_TeamMembers_TeamMemberId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectTasks_TeamLeadId",
                table: "ProjectTasks",
                column: "TeamLeadId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamLeads_ApplicationUserId",
                table: "TeamLeads",
